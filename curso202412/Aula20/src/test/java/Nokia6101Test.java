...
public class Nokia6101Test {
    ...
    @Test
    public void deveImpedirCapturaDeFotoQuandoEmNivelCritico(){
        //Arrange
        Nokia6101 nokia6101 = new Nokia6101("Nokia 6101");
        double nivelBateriaEsperado = 9;

        //Act
        nokia6101.consumirBateria(90);

        nokia6101.capturarFotografia();

        //Assert
        //Assert.assertEquals(nivelBateriaEsperado, nokia6101.getNilveBateria(), 0.001);
    }
}
